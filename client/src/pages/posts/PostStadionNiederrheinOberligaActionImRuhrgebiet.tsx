...
import heroImg from '@assets/generated_images/Stadion_Niederrhein_7f358c95.png';
...
const PostStadionNiederrheinOberligaActionImRuhrgebiet: React.FC = () => {
  const title = "Stadion Niederrhein: Oberliga-Action im Ruhrgebiet";
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <header className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">22.09.2024 — Stadion Niederrhein — Oberhausen — Oberliga — Ergebnis: 3:2</p>
        </header>
        <div className="post-hero mb-6">
          <img src={heroImg} alt={title} className="w-full h-auto object-cover" />
        </div>
        <article className="prose">
          <p>Oberliga-Fußball vom Feinsten. Das Stadion Niederrhein bot die perfekte Kulisse für spannende 90 Minuten voller Kampfgeist.</p>
...
export default PostStadionNiederrheinOberligaActionImRuhrgebiet;
