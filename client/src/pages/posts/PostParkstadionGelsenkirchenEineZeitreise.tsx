...
const PostParkstadionGelsenkirchenEineZeitreise: React.FC = () => {
  const title = "Parkstadion Gelsenkirchen: Eine Zeitreise";
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <header className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">01.08.2024 — Parkstadion — Gelsenkirchen — Freundschaftsspiel — Ergebnis: 1:1</p>
        </header>
        <div className="post-hero mb-6">
          <img src={heroImg} alt={title} className="w-full h-auto object-cover" />
        </div>
        <article className="prose">
          <p>Das legendäre Parkstadion - ein Ort voller Geschichte. Ein nostalgischer Trip durch die Fußballkultur des Ruhrgebiets.</p>
...
export default PostParkstadionGelsenkirchenEineZeitreise;
