...
const PostFlutlichtspielInOberhausen: React.FC = () => {
  const title = "Flutlichtspiel in Oberhausen";
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <header className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">12.10.2024 — Stadion Niederrhein — Oberhausen — Oberliga — Ergebnis: 4:1</p>
        </header>
        <div className="post-hero mb-6">
          <img src={heroImg} alt={title} className="w-full h-auto object-cover" />
        </div>
        <article className="prose">
          <p>Unter Flutlicht entfaltet Fußball seinen ganz eigenen Charme. Ein Torfestival im Stadion Niederrhein.</p>
...
export default PostFlutlichtspielInOberhausen;
