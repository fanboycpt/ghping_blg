...
const PostWattenscheidVsRwe: React.FC = () => {
  const title = "SG Wattenscheid 09 \u2013 VfL Bochum II";
  const images = [img1];
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <header className="mb-6">
          <h1 className="text-3xl font-heading mb-2">{title} — 28.10.2024</h1>
          <p className="text-sm text-muted-foreground">Stadion: Lohrheidestadion, Bochum • Ergebnis: 1:2</p>
        </header>
        <div className="post-hero mb-6">
          <img src={images[0]} alt={title} className="w-full h-auto object-cover rounded" />
        </div>
        <article className="prose">
          <p>Stadion & Atmosphäre: Lohrheidestadion, Bochum. Typischer Groundhop: ein Hauch von Rost, die Stimme eines Stadionsprechers, und eine Bratwurst, die ihr eigenes Pflichtprogramm hat.</p>
...
export default PostWattenscheidVsRwe;