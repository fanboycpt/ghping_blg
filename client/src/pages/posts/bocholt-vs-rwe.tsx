...
const PostBocholtVsRwe: React.FC = () => {
  const title = "1. FC Bocholt \u2013 Rot-Weiss Essen";
  const images = [img1];
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <header className="mb-6">
          <h1 className="text-3xl font-heading mb-2">{title} — 06.06.2024</h1>
          <p className="text-sm text-muted-foreground">Stadion: Stadion am Hünting, Bocholt • Ergebnis: 1:0</p>
        </header>
        <div className="post-hero mb-6">
          <img src={images[0]} alt={title} className="w-full h-auto object-cover rounded" />
        </div>
        <article className="prose">
          <p>Stadion & Atmosphäre: Stadion am Hünting, Bocholt. Typischer Groundhop: ein Hauch von Rost, die Stimme eines Stadionsprechers, und eine Bratwurst, die ihr eigenes Pflichtprogramm hat.</p>
...
export default PostBocholtVsRwe;